...
function popup1() {
    CreativaPopup.create('Feel free to DM me muzw', 'Discord');
}
...
function popup13() {
    CreativaPopup.create('Feel free to DM me <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">MUZW</font> &#10084<br>MUZW<font style="color: #696969; font-size: smaller;"> or join precise cheats <a href="https://discord.gg/precise" style="color: #ADD8E6;">https://discord.gg/precise</a> </font>', 'Discord', '', {
        titleColor: '#6ffcff',
        textColor: '#b0b0b0'
    });
...
function allahm109kd() {
    navigator.clipboard.writeText("muzw");
    setTimeout(function() {
